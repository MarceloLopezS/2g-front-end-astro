...
class Dropdown {
  constructor(selectElement) {
    ...
    this.selectOptions =
      getFormattedOptions(this.selectElement.querySelectorAll('option'));
  ...
  selectOptionFromValueMatch(value) {
    const newSelectedOption =
      this.selectOptions.find(option => option.value === value);
    ...
    const prevDropDownOptionSelected =
      this.dropDownList.querySelector(
        `[data-value='${prevSelectedOption.value}']`
      );
    const newDropDownOptionSelected =
      this.dropDownList.querySelector(
